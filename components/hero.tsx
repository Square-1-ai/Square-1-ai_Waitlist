            ...
            {[
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-lg sm:text-xl font-bold text-blue-600 mb-2 sm:mb-3">{feature.title}</h3>
                  <p className="text-sm sm:text-base text-blue-700">{feature.description}</p>
                </div>
              );
            })}
          </div>
