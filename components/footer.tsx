      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 pl-2 text-slate-300 text-sm">
              <li>
          ...
          <div>
            ...
            <p className="hidden">Follow us for updates and announcements.</p>
            ...
            <ul className="space-y-2 pl-2 mb-4">
              <li>
                <a href="https://www.instagram.com/square1ai/" className="flex items-center gap-2 text-slate-300 text-sm hover:text-white transition-colors" aria-label="Instagram">
                  <Image src="/instagram.svg" alt="Instagram" width={16} height={16} className="w-4 h-4" />
                  <span>Instagram</span>
                </a>
              </li>
              <li>
                <a href="#" className="flex items-center gap-2 text-slate-300 text-sm hover:text-white transition-colors" aria-label="Facebook">
                  <Image src="/facebook.svg" alt="Facebook" width={16} height={16} className="w-4 h-4" />
                  <span>Facebook</span>
                </a>
              </li>
              <li>
                <a href="https://www.tiktok.com/@square1_ai" className="flex items-center gap-2 text-slate-300 text-sm hover:text-white transition-colors" aria-label="TikTok">
                  <Image src="/tiktok.svg" alt="TikTok" width={16} height={16} className="w-4 h-4" />
                  <span>TikTok</span>
                </a>
              </li>
              <li>
                <a href="#" className="flex items-center gap-2 text-slate-300 text-sm hover:text-white transition-colors" aria-label="LinkedIn">
            ...
            <div className="flex gap-4 hidden">
              <a href="https://www.instagram.com/square1ai/" className="text-slate-300 hover:text-white transition-colors" aria-label="Instagram">
              ...
              <a href="https://www.tiktok.com/@square1_ai" className="text-slate-300 hover:text-white transition-colors" aria-label="TikTok">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
