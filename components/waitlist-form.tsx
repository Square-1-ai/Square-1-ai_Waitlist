...
export default function WaitlistForm({ onSubmit }: WaitlistFormProps) {
  ...
  const handlePreferenceChange = (pref: string, type: "student" | "teacher") => {
    if (type === "student") {
      setFormData((prev) => ({
        ...prev,
  ...
  const getProgressPercentage = () => {
    const maxSteps = userType ? 5 : 4
    return (step / maxSteps) * 100
  }

  return (
    <section id="form" className="py-16 md:py-24 px-4 bg-gradient-to-b from-white to-blue-50">
      <div className="max-w-2xl mx-auto">
        {/* Progress Bar */}
        <div className="mb-8">
          <div className="flex justify-between items-center mb-2">
            <h2 className="text-2xl font-bold text-blue-900">Waitlist Form</h2>
            <span className="text-sm font-medium text-blue-700">
              Step {step} of {userType ? 5 : 4}
            </span>
          </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-8 shadow-lg">
            ...
            <div className="space-y-6 animate-fade-in">
              ...
              <div>
                ...
                <div className="space-y-2">
                  {["Smartphone", "Laptop / Desktop", "Tablet", "Shared school or community computer"].map((device) => (
          ...
          {step === 2 && (
            <div className="space-y-6 animate-fade-in">
              <h3 className="text-xl font-bold text-blue-900 mb-8">What best describes you?</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                >
                  ...
                  <h4 className="text-xl font-bold text-blue-900">I'm a Student</h4>
                  <p className="text-blue-700 text-sm mt-2">Eager to learn and grow</p>
                </button>
                ...
                >
                  <div className="text-5xl mb-4">👩‍🏫</div>
                  <h4 className="text-xl font-bold text-blue-900">I'm a Teacher</h4>
                  <p className="text-blue-700 text-sm mt-2">Ready to inspire and share</p>
                </button>
              </div>
            </div>
          )}
                  ...
                  {["AI Study Packs", "Live Class Demos", "Competitions", "Student Community"].map((pref) => (
                    <label key={pref} className="flex items-center gap-3 cursor-pointer">
                      <input
                        ...
                        onChange={() => handlePreferenceChange(pref, "student")}
                        className="w-5 h-5 rounded border-blue-300 text-blue-600 focus:ring-blue-500"
                      />
                    ...
                    (pref) => (
                      <label key={pref} className="flex items-center gap-3 cursor-pointer">
                        <input
                          ...
                          onChange={() => handlePreferenceChange(pref, "teacher")}
                          className="w-5 h-5 rounded border-blue-300 text-blue-600 focus:ring-blue-500"
                        />
                        <span className="text-blue-700">{pref}</span>
                      </label>
          ...
          {step === 4 && (
            <div className="space-y-6 animate-fade-in">
              <h3 className="text-xl font-bold text-blue-900 mb-4">One final step...</h3>
          ...
          <div className="flex gap-4 mt-8 pt-6 border-t border-blue-100">
            ...
            {step < 4 && (
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg font-medium hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all"
              >
                Next
